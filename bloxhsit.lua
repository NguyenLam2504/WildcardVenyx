...
ImageButton.MouseButton1Down:connect(function()
    ...
    spawn(
        ...
        local Item = Tabs.Item:AddSection("Misc Farm")
        if Third_Sea then
            ...
            Tabs.Item:AddToggle("ToggleSpawnCake", {Title = "Auto Spawn Cake Prince", Default = true})
    ...
    if Second_Sea then
        local ToggleVatChatKiDi = Tabs.Item:AddToggle("ToggleVatChatKiDi", {Title = "Auto Ectoplasm", Default = false})
    ...
    local boss = Tabs.Item:AddSection("Boss Farm")
    ...
    local ToggleAutoFarmBoss = Tabs.Item:AddToggle("ToggleAutoFarmBoss", {Title = "Kill Boss", Default = false})
    ...
    local Material = Tabs.Item:AddSection("Material Farm")
    ...
    local ToggleMaterial = Tabs.Item:AddToggle("ToggleMaterial", {Title = "Auto Material", Default = false})
